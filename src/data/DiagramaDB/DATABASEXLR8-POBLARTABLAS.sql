...
(4, 'Remera Dryfit', 'https://bit.ly/3m2xAcr', 'Remera Dryfit. Este producto está hecho parcialmente con Parley Ocean Plastic. Solo una de las innovaciones que representan el compromiso de adidas de ayudar a acabar con los residuos plásticos.', 4250, 12, 'small', 'blanco', 'unisex', 'remera', 1),
...
(8, 'Short Jogger', 'https://bit.ly/3ExbxRk', 'Short Jogger. Bermuda Bengalina Elastizada Hombre Cintura Elastizada Con Bolsillos. Corte Regular.', 8299, 8, 'medium', 'azul', 'hombre', 'short', 1),
...
(10, 'Remera Lady', 'https://bit.ly/3Et2Ibd', 'Remera Sport Mujer. La tecnología UA Microthread en la tela se seca más rápido, no se adhiere a ti, no se irrita y se estira sin absorber el sudor.', 5999, 15, 'large', 'negro', 'mujer', 'remera', 0);
UNLOCK TABLES;
